  ...
  <body>
    ...
    <form id="PMR-edit">
      <fieldset>
        ...
        <input id="wbx-pmr-pin" name="pmr-host-pin-edit" value="" type="text" placeholder="Host PIN">
    ...
    <form id="dialer">
      <fieldset>
        ...
        <input id="pin-join" title="pin" value="" type="text"/>
      ...
      <p>
        <label for="setMeetingQualityLevel">Meeting Join Quality Level</label>
        <select id="setMeetingQualityLevel" name="setMeetingQualityLevel">
          <option value="LOW">LOW (320x180)</option>
          <option value="MEDIUM">MEDIUM (640x360)</option>
          <option value="HIGH" selected>HIGH (1280x720)</option>
        </select>
        <span>(Default is HIGH)</span>
      </p>
        <label>
    ...
    <form id="call-controls">
      <fieldset>
        ...
        <p>
          <label for="updateMeetingQualityLevel">Update Meeting Quality Level</label>
          <select id="updateMeetingQualityLevel" name="updateMeetingQualityLevel">
            <option value="LOW">LOW</option>
            <option value="MEDIUM">MEDIUM</option>
            <option value="HIGH">HIGH</option>
          </select>
          <button id="updateMeetingQuality" title="meeting.setMeetingQuality()" type="button">meeting.setMeetingQuality()</button>
        </p>
        <p>
          <label for="updateLocalVideoQualityLevel">Update Local Video Quality</label>
          <select id="updateLocalVideoQualityLevel" name="updateLocalVideoQualityLevel">
            <option value="LOW">LOW (320:180)</option>
            <option value="MEDIUM">MEDIUM (640:360)</option>
            <option value="HIGH">HIGH (1280:720)</option>
          </select>
          <button id="updateLocalVideoQuality" title="meeting.setLocalVideoQuality()" type="button">meeting.setLocalVideoQuality()</button>
        </p>
        <p>
          <label for="updateRemoteMeetingQualityLevel">Update Remote Quality Level</label>
          <select id="updateRemoteMeetingQualityLevel" name="updateRemoteMeetingQualityLevel">
            <option value="LOW">LOW</option>
            <option value="MEDIUM">MEDIUM</option>
            <option value="HIGH">HIGH</option>
          </select>
          <button id="updateRemoteMeetingQuality" title="meeting.setRemoteQualityLevel()" type="button">meeting.setRemoteQualityLevel()</button>
        </p>
      </fieldset>
    </form>
    ...
    <div style="width:75%;">
      ...
      <canvas id="myChart2"></canvas>
        ...
        <h2>Extras</h2>
        <button id="upload-logs">uploadLogs</button>
