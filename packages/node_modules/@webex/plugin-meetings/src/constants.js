...
export const EVENT_TRIGGERS = {
  ...
  METRICS_MEDIA_PAYLOAD: 'metrics:payload'
};
...
export const STATS = {
  audioCorrelate: 'audio',
  videoCorrelate: 'video',
  shareCorrelate: 'share',
  audioSenderId: 'audioSender',
  audioReceiverId: 'audioReceiver',
  videoSenderId: 'videoSender',
  videoReceiverId: 'videoReceiver',
  shareSenderId: 'shareSender',
  shareReceiverId: 'shareReceiver',
  END: 'end',
  DATA: 'data',
  CLOSED: 'closed',
  SENDER: 'sender',
...
export const MQA_STATS = {
  ...
  CA_TYPE: 'MQA',
  DATA_PLACEMENTS: [STATS.audioSenderId, STATS.audioReceiverId, STATS.videoSenderId, STATS.videoReceiverId, STATS.shareSenderId, STATS.shareReceiverId],
