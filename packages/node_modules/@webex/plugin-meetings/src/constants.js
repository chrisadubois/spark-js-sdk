...
export const MEETING_REMOVED_REASON = {
  ...
  FULLSTATE_REMOVED: 'FULLSTATE_REMOVED', // meeting got dropped ?
...
export const CALL_REMOVED_REASON = {
  CALL_INACTIVE: 'CALL_INACTIVE', // server or host removed you from the meeting
  PARTNER_LEFT: 'PARTNER_LEFT', // meeting got dropped ?
