export default {
  ...
  meetings: {
    ...
    stats: {
      ...
      historyMax: 120,
      // send a metrics event automatically
      autoSendMediaDiagnostics: false,
      // dispatch data every 10 seconds
      // so that metrics consumer doesn't get flooded
      mediaDiagnosticsInterval: 10
    },
    metrics: {
      // change to your client name else data will be muddled
      clientType: 'WEBEX_JS_SDK_MEETING_CLIENT',
      // send MQA in 30 second intervals
      mqaMetricsInterval: 30,
