...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  ...
  getAnalyzerMetricsPrePayload(options) {
    if (options) {
      ...
      if (options.type === 'MEDIA_QUALITY_ANALYZER') {
        payload = Metrics.initMediaPayload(identifiers, options);
      }
  ...
  sendMediaQualityAnalyzerMetrics(options) {
    ...
    options.clientType = this.config.meetings.metrics.clientType;
    const payload = this.getAnalyzerMetricsPrePayload(options);
   ...
   */
  autoStats() {
    const automaticMetrics = new StatsMetrics(this.attrs, this.options);
