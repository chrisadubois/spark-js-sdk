...
import {CALENDAR_REGISTRED, CALENDAR_UNREGISTRED, CALENDAR_DELETE, CALENDAR_CREATE, CALENDAR_UPDATED} from './constants';
...
const Calendar = WebexPlugin.extend({
  ...
  register() {
    ...
    return this.webex.internal.device.register()
      ...
      .then(() => {
        ...
        this.trigger(CALENDAR_REGISTRED);
  ...
  unregister() {
    ...
    return this.webex.internal.mercury.disconnect()
      ...
      .then(() => {
        this.trigger(CALENDAR_UNREGISTRED);
  ...
  _handleUpdate(data) {
    ...
    console.log('TRIGGRED UPDATE', id);
